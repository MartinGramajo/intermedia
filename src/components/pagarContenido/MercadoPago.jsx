        ...
        <div className="mercado-carta">
          <div className="content-mercado-carta ">
            ...
            <div className="container d-flex justify-content-between ">
              <div className="mx-3">
                <h2 className="peso-700 fs-16">VPN</h2>
              </div>
              <div className="mx-3">
                <h2 className="peso-500 fs-16">$5.700</h2>
              </div>
            </div>
            <div className=" container d-flex justify-content-between ">
              <div className="mx-3">
              ...
              <div className="mx-3">
                <h2 className="peso-500 fs-16">$500</h2>
              </div>
            </div>
            <div className=" container d-flex justify-content-between ">
              <div className="mx-3">
              ...
              <div className="mx-3">
                <h2 className="peso-500 fs-16">$2.200</h2>
              </div>
            </div>
            <hr />
            <div className=" container d-flex justify-content-between ">
              ...
              <div className="mx-3">
                <h2 className="peso-800 fs-16 ">$8.400</h2>
              </div>
            </div>
            <div className="d-flex justify-content-center">
              <Button
