...
const arrayTextos = [
    {
        ...
        El hosting web aloja online los contenidos de tu web y de tu correo electrónico para que puedan ser visitados
        en todo momento desde cualquier dispositivo conectado a Internet.`,
    },
    {
        id: 2,
...
export default function PreguntasFrecuentes() {
    return (
        <div className="fondo-celeste">
            <div className="container acordeon-pf">
                ...
                <Accordion className="padding-pf">
                    {arrayTextos.map((textos) => (
                        <Accordion.Item eventKey={textos.id} >
                            ...
                            <Accordion.Body>
                                <pre className="peso-400 fs-22 pre-wrap">
                                    {textos.descripcion}
                                </pre>
                            </Accordion.Body>
                        </Accordion.Item>
