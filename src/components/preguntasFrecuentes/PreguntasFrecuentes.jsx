...
Si necesitás más datos del servicio por favor comunicate con nosotros vía chat o mandanos un mail a: `,
        descripcion2: "",
        tarjetaA: "",
        tarjetaB: "",
        tarjetaC: "",
...
Nuestra red e instalaciones se encuentran monitoreadas activamente 7x24, lo que te brinda la garantía de seguridad y disponibilidad que tu proyecto en la web necesita.`,
    ...
    },
    {
        ...
        descripcion: "Tenemos varias formas de pago: Tarjeta de crédito:",
        descripcion2:
            "*dependiendo de tu banco emisor podrás pagar en cuotas Tarjeta de débito En efectivo en puntos de pago:",
        descripcion3:
            "Transferencia bancaria. Consultar CVU (Clave Virtual Única):0000003100081300003223",
        tarjetaA: tarjetas1,
        tarjetaB: tarjetas2,
        tarjetaC: tarjetas3,
    },
...
export default function PreguntasFrecuentes() {
    ...
    return (
        <div className="fondo-celeste" id="faq">
                            ...
                            <Accordion.Body>
                                {textos.id === 11 ? (
                                    <pre className="peso-400 fs-22 pre-wrap ms-5 ps-1">
                                        {textos.descripcion}
                                        <a
                                            href={`mailto:${"ventas@intermediasp.com"}`}
                                            className="peso-400 fs-22 pre-wrap"
                                        >
                            ...
                            <Accordion.Body className="p-3">
                                {textos.id === 11 ? (
                                    <pre className="peso-500 fs-16 pre-wrap">
                                        ...
                                        <a
                                            href={`mailto:${"ventas@intermediasp.com"}`}
                                            className="peso-500 fs-16 pre-wrap"
                                        >
                                            ventas@intermediasp.com
                                        </a>
                                    </pre>
            ...
            <Accordion.Body>
              <pre className="peso-500 fs-16 pre-wrap">
                Tenemos varias formas de pago: Tarjeta de crédito:
              </pre>
              <Image className="mb-3" src={tarjetas1} fluid alt="tarjetas" />
              <Image className="mb-3" src={tarjetas2} fluid alt="tarjetas" />
              <pre className="peso-500 fs-16 pre-wrap">
                *dependiendo de tu banco emisor podrás pagar en cuotas Tarjeta
                de débito En efectivo en puntos de pago:
              </pre>
              <Image className="mb-3" src={tarjetas3} fluid alt="tarjetas" />
              <pre className="peso-500 fs-16 pre-wrap">
                Transferencia bancaria. Consultar CVU (Clave Virtual Única):
                0000003100081300003223
              </pre>
            </Accordion.Body>
          </Accordion.Item> */}
                </Accordion>
